...
- First-party vendor documentation or engineering blog about own product (authoritative for facts, but inherent promotional framing — e.g., the vendor writing about OpenClaw, LangChain surveying their own users, or a company benchmarking their own compression algorithm)
